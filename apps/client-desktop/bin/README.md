...
- `manifest.txt` - runtime manifest used by the desktop self-test
- `*.sha256` - SHA256 sidecars for bundled runtime binaries
...
- `build.ps1` and `build-portable.ps1` also regenerate `manifest.txt` and `*.sha256`
