...
class AdminAccessControl:
    ...
    DEFAULT_PERMISSION_MATRIX: dict[str, dict] = {
        ...
        "lust_egress_pools.read": {"roles": ["l2", "l3", "audit", "admin"], "description": "Read LuST egress pools"},
        "lust_egress_pools.write": {"roles": ["l2", "l3", "admin"], "description": "Modify LuST egress pools"},
        "lust_route_maps.read": {"roles": ["l2", "l3", "audit", "admin"], "description": "Read LuST route maps"},
        "lust_route_maps.write": {"roles": ["l2", "l3", "admin"], "description": "Modify LuST route maps"},
    ...
    def classify_permission(self, request: Request) -> str | None:
        ...
        path_groups = {
            ...
            "lust-egress-pools": "lust_egress_pools",
            "lust-route-maps": "lust_route_maps",
